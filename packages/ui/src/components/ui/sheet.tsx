  ...
  "app-fixed app-z-50 app-gap-4 app-bg-background app-p-6 app-shadow-lg app-transition app-ease-in-out data-[state=open]:app-animate-in data-[state=closed]:app-animate-out data-[state=closed]:app-duration-300 data-[state=open]:app-duration-500",
  {
    variants: {
      side: {
        ...
        left: "app-inset-y-0 app-left-0 app-h-full app-w-full app-border-r data-[state=closed]:app-slide-out-to-left data-[state=open]:app-slide-in-from-left sm:app-max-w-sm",
        right:
          "app-inset-y-0 app-right-0 app-h-full app-w-full app-border-l data-[state=closed]:app-slide-out-to-right data-[state=open]:app-slide-in-from-right sm:app-max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="app-absolute app-right-4 app-top-4 app-rounded-sm app-opacity-70 app-ring-offset-background app-transition-opacity hover:app-opacity-100 disabled:app-pointer-events-none data-[state=open]:app-bg-secondary">
        <MaterialSymbol className="app-h-6 app-w-6" symbol="close" />
